...
/** OKR objective; {@code progress} maintained by {@link com.kairos.service.OKRRollupService}. */
@Entity
...
public class Objective {
    ...
    @OneToMany(mappedBy = "objective", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.EAGER)
